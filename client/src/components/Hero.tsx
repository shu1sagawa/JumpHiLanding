      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="flex flex-col items-center">
          <div className="w-full text-center">
            ...
            <div className="flex flex-row justify-center space-x-4 mt-6 mb-14">
              <a 
                ...
                target="_blank"
                className="flex items-center justify-center bg-gradient-to-r from-secondary to-accent text-white px-6 py-3 rounded-full font-medium hover:shadow-lg transition-transform hover:scale-105"
              >
              ...
              <a 
                ...
                target="_blank"
                className="flex items-center justify-center bg-gradient-to-r from-primary to-[#ff8c6e] text-white px-6 py-3 rounded-full font-medium hover:shadow-lg transition-transform hover:scale-105"
              >
          ...
          <img 
            ...
            className="w-full max-w-5xl h-auto -mt-40"
          />
        </div>
      </div>
